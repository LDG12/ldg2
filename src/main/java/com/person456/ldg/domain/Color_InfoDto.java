...
public class Color_InfoDto {
    ...
    public Color_InfoDto(Integer cid, Integer sno, String cell_color) {
        this.cid = cid;
        this.sno = sno;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(cid, that.cid) && Objects.equals(sno, that.sno) && Objects.equals(cell_color, that.cell_color);
    }

    @Override
    public int hashCode() {
        return Objects.hash(cid, sno, cell_color);
    }
